...
//meta title
useHead({
  title: 'Welcome - astechroid.com',
});

const { pending: incomePending, data: incomeList } = await useFetch('/api/income')
const { pending: cartPending, data: cartList } = await useFetch('/api/cart')
const cartLabels = cartList._rawValue.products.map(el => {
    return el.title
})
const cartSeries = cartList._rawValue.products.map(el => {
    return el.quantity
})
// console.log(cartList._rawValue.products)
...
const incomeSeries = incomeList._rawValue.pendapatan;
</script>
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  <div class="pt-4">
                    ...
                    <div class="mt-4">
                      <a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light btn-sm">View Profile
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="mt-4">
                    <a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light btn-sm">View More <i
